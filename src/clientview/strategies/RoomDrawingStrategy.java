...
public abstract class RoomDrawingStrategy {
    ...
    public abstract void drawRoomFromAbove(Room r, Graphics g, int xOffset, int yOffset, int xOffPx, int inventoryHeight);

    public abstract void drawDoors(Room r, Graphics g, MapPanel mapPanel, int xOffset, int yOffset, int xOffPx, int inventoryHeight);
}

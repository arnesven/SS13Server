...
public class SecretGameMode extends MapSavedToDisk<String, Double> {
	...
	private static final double[] probabilities = {0.15,      0.30,         0.15,         0.12,       0.04,     0.03,     0.05,    0.05,     0.05,       0.03,    0.03};
    private static final String[] modeNames =   {"Host", "Traitor", "Operatives", "Changeling", "Rogue AI", "Mutiny",  "Wizard", "Hunt", "Pirates",   "Mixed", "Armageddon"};

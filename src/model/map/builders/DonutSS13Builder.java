...
public class DonutSS13Builder extends MapBuilder {
    ...
    protected void buildPart(GameData gameData, GameMap gm) {
        ...
        Room chapel = new ChapelRoom(2, 2, 4, 2, 2, new int[]{5}, new double[]{4.0, 5.0}, RoomType.support);
        ...
        Room bar = new BarRoom(gameData, 10, 6, 10, 3, 2, new int[]{8, 9, 12}  ,         new double[]{7.5, 10.0, 9.0, 11.5}, RoomType.support);
        ...
        Room aiCore = new AIRoom(gameData, 15, 10,  7, 2, 2, new int[]{13}        ,         new double[]{}, RoomType.tech );
        ...
        Room CQ = new CaptainsQuartersRoom(gameData, 20, 15,  8, 2, 2, new int[]{17}        ,         new double[]{16.0, 8.0} , RoomType.command);
        ...
        Room sickbay = new SickbayRoom(24, 6,  0, 3, 3, new int[]{23, 25, 1} ,         new double[]{}, RoomType.science );
        ...
        Room panorama = new PanoramaRoom(27, 1,  3, 1, 3, new int[]{1, 3}      ,         new double[]{}, RoomType.hall );

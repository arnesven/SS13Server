...
public class DonutSS13Builder extends MapBuilder {
    ...
    protected void buildPart(GameData gameData, GameMap gm) {
        ...
        Room frontHall = new HallwayRoom(13, "Front Hall"          , "FRONT"     ,12,  6, 2, 4, new int[]{11, 14, 16, 448},     new double[]{13.5, 10.0, 12.0, 8.0, 13.5, 6.0});
        ...
        Room robotics = new RoboticsRoom(448, 10, 7, 2, 2, new int[]{13, 15}, new double[]{});
        ...
        Room nukieShip2 = new NukieShipStorageRoom(128, 18, 12, 1, 2, new int[]{28, 7, 21, 25}, new double[]{});

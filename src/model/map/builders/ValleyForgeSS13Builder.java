...
public class ValleyForgeSS13Builder extends MapBuilder {
    ...
    protected void buildPart(GameData gameData, GameMap gm) {
        ...
        Room aftHall = new Room(16, "Aft Hall", "AFT",11,  3, 2, 3, new int[]{26, 23, 21}, new double[]{11.5, 3, 11.0, 3.5}, RoomType.hall );
        ...
        gm.addRoom(new SecurityRoom(gameData, 18, 12, 11, 2, 2, new int[]{11}, new double[]{12, 12} , RoomType.security, aftHall ), ss13, "front");
        gm.addRoom(new AIRoom(gameData, 15, 11,  6, 2, 2, new int[]{23}        ,         new double[]{}, RoomType.tech ), ss13, "center");
        gm.addRoom(new Room( 9, "Stairs B"  , "B" , 11,  8, 2, 1, new int[]{23, 11, 6, 4}, new double[]{11.5, 9}, RoomType.hall ), ss13, "center");
        ...
        gm.addRoom(new SickbayRoom(24, 16,  9, 3, 2, new int[]{5, 4, 7} , new double[]{16, 9.5}, RoomType.science ), ss13, "A-DECK");
        gm.addRoom(new AirLockRoom( 7,  1,  19, 9, 1, 1, new int[]{24} , new double[]{19, 9.5} ), ss13, "A-DECK");
        gm.addRoom(new Room( 4, "Stairs A", "A", 17,  8, 2, 1, new int[]{3, 24, 9}, new double[]{17.5, 8, 17.5, 9}, RoomType.hall), ss13, "center");
        ...
        // C DECK
        Room gate = new Room(13, "Shuttle Gate", "Gate", 2,  6, 3, 3, new int[]{14, 8, 6}, new double[]{}, RoomType.hall );
        ...
        gm.addRoom(new DormsRoom(12, 7, 6, 2, 3, new int[]{8, 6, 10}, new double[]{7, 6.5} , RoomType.support), ss13, "C-DECK");
        gm.addRoom(new OfficeRoom(gameData, 14, 3, 4, 2, 2, new int[]{13}, new double[]{4.5, 6}, RoomType.command ), ss13, "C-DECK");
